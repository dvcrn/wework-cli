...
const OWNER = "dvcrn";
const REPO = "wework-cli";
const BIN = "wework";
const VERSION_ENV = "WEWORK_VERSION";
const BASE_URL_ENV = "WEWORK_BASE_URL";
const ARCH_ENV = "WEWORK_ARCH";
const PLATFORM_ENV = "WEWORK_PLATFORM";
...
(async function main() {
  try {
    ...
    if (!["darwin", "linux", "windows"].includes(platform)) {
      console.error("wework: npm install supports macOS (darwin), Linux, and Windows only");
      process.exit(1);
    }
